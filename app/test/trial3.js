...
module.exports = async function(callback) {
	...
	log_result(await patientA_SC.newPermissionGroup(accounts[2], "generic", {from: patientA}));
	...
	log_result(await patientA_SC.newPermissionGroup(accounts[3], "generic", {from: patientA}));
	try {
